...
def test_tc_delta_pairs():
    ...
    tc2 = TimeConfig('2022-03-24', 2.1/52, 2)
    ...
    tc3 = TimeConfig('2022-03-24', 2.1/52, 3)
    ...
    tc4 = TimeConfig('2022-03-24', 2.1/52, 4)
...
def test_tc_gap_fill():
    ...
    tc = TimeConfig('2022-03-24', 1.4/52, 2)
...
def test_tc_sigma_sequence():
    ...
    tc = TimeConfig('2022-03-24', 2.5/52, 3)
...
def test_sequences_inc_offsets():
    ...
    delta_size = 2
    seq_length = 5
    tc25 = TimeConfig('2022-04-14', 5.5/52, delta_size, inc_offsets=True)
    ...
    delta_size = 4
    seq_length = 2
    tc42 = TimeConfig('2022-04-14', 5.5/52, delta_size, inc_offsets=True)
